...
#   "20 degrees" steering and "15 degrees" brake are only correct if the
...
# Steering: validated mechanical limit = 20 degrees each side from center.
STEER_LIMIT = 20.0

# Brake: max 15 degrees; APPLY direction reversed from previous build.
BRAKE_LIMIT = 15.0
...
STEER_GEAR_RATIO = 51.0 / 17.0   # 3.0:1
...
# ============================================================
#
# Validated steering direction:
#   Steering RIGHT = DIR 1
#   Steering LEFT  = DIR 0
#
# Brake APPLY rotation has been reversed from the previous build.
# ============================================================
...
# Brake APPLY direction reversed from previous build.
# All brake limits/timing/behavior remain unchanged.
BRAKE_POSITIVE_DIR = 0
...
#
# Loaded steering timing validated during bench testing:
#   start period = 1800 us
#   fast period  = 800 us
#   acceleration = 5 us reduction per step
#
# Steering gearing:
#   17T motor gear -> 51T steering gear = 3.0:1
#   3200 pulses/motor rev -> 26.667 pulses/steering degree
#
...
STEER_START_PERIOD_US = 1800
STEER_FAST_PERIOD_US = 800
STEER_ACCEL_US_PER_STEP = 5
...
print("Pass :", PASSWORD)
print("URL  : http://" + IP)
print("Steering : -20 to +20 deg")
print("Brake    : 0 to +15 deg")
...
//   hold       -> continuous motion toward +/-20 degree mechanical limits
        ...
        try:
            ...
            try:
                ...
                if path.startswith("/estop_reset"):
                    ...
                    print("!!! E-STOP - THROTTLE ZERO / BRAKE APPLIED !!!")
                    response(client, "OK")
                    continue
